...
# Actions
# A1 - Clone github
git clone https://github.com/zuocsfm/map_image_analysis.git /odtp/odtp-workdir/complexity-analysis
cd /odtp/odtp-workdir/complexity-analysis
git checkout 36e3b3d
